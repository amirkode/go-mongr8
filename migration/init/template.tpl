...
{{ define "migration_sub_action_schemas" }}
/*
DOT NOT EDIT, THIS FILE IS GENERATED BY CODE GEN
Create date: {{ .CreateDate}}
Created by: go-mongr8
...
func GetAllMigrationSubActionSchemas() []api_interpreter.SubActionSchema {
	return []api_interpreter.SubActionSchema{}
}
{{ end }}
...
import (
	collection_no_edit "github.com/amirkode/go-mongr8/mongr8/collection/no_edit"
	migration_no_edit "github.com/amirkode/go-mongr8/mongr8/migration/no_edit"
...
func CmdGenerateMigration() {
	...
	migrationSubActionSchemas := migration_no_edit.GetAllMigrationSubActionSchemas()
